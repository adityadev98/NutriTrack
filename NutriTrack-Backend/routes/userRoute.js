...
import { bookAppointment, listAppointment, listAvailableCoaches , cancelAppointment, paymentStripe, verifyStripe, chatWithGPT } from '../controllers/userController.js';
...
userRouter.post("/chat", authMiddleware, chatWithGPT);
