...
describe('NutriControllers', () => {
	...
	describe('GET /api/mealsConsumed', () => {
        ...
        it('should return 404 if no meals consumed for today', async () => {
            ...
            expect(res.body).toStrictEqual({ failure: true, message: 'No meals consumed for today' });
        });
        ...
        it('should return 500 if there is an error', async () => {
            ...
            expect(res.statusCode).toEqual(500);
            expect(res.body).toStrictEqual({ failure: true, message: 'Error in retreiving data' });
        });
    });
    
	describe('POST /api/customFood', () => {
		it('should add a custom food item', async () => {
			const res = await request(app).post('/api/customFood').send({
				userId: new mongoose.Types.ObjectId(),
    ...
    describe('GET /api/getCustomFood', () => {
        ...
        it('should return 404 if no custom foods found', async () => {
            ...
            console.log('Error Response:', res.body); 
            expect(res.statusCode).toEqual(404);
            expect(res.body).toStrictEqual({ failure: true, message: 'No custom meals found' });
        });
        ...
        it('should return 500 if there is an error', async () => {
            ...
            console.log('Error Response:', res.body); 
            expect(res.statusCode).toEqual(500);
            expect(res.body).toStrictEqual({ failure: true, message: 'Error in retrieving data' });
