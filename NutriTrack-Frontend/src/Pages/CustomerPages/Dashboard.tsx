...
const Dashboard: React.FC = () => {
  ...
  const getHydrationMessage = () => {
    ...
    if (waterPercentage < 70 && waterPercentage > 30) return "Progress is going well!";
      ...
      <Container maxW="container.lg" py={6}>
        <VStack gap={4} align="center">
          ...
          <Box p={5} shadow="md" borderWidth="1px" borderRadius="md" bg="var(--soft-white)" width="100%">
            <StatGroup>
              <Stat>
                <StatLabel>Name</StatLabel><StatNumber>{profile.name}</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>Age</StatLabel><StatNumber>{profile.age}</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>Gender</StatLabel><StatNumber>{profile.gender}</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>Activity Level</StatLabel><StatNumber>{profile.activityLevel}</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>Height</StatLabel><StatNumber>{profile.height} cm</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>Weight</StatLabel><StatNumber>{profile.weight} kg</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>Daily Calorie Needs</StatLabel><StatNumber>{Math.round(tdee)} kcal</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>Daily Protein Needs</StatLabel><StatNumber>{Math.round(proteinNeeds)} g</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>BMI</StatLabel><StatNumber>{bmi.toFixed(2)}</StatNumber>
              </Stat>
            </StatGroup>
